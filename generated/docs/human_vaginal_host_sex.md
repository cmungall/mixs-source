...
URI: [mixs.vocab:human_vaginal_host_sex](https://w3id.org/mixs/vocab/human_vaginal_host_sex)


## Domain and Range

[Human-vaginal](Human-vaginal.md) &#8594;  <sub>0..1</sub> [host_sex_enum](host_sex_enum.md)
