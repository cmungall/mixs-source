...
URI: [mixs.vocab:hydrocarbon_resources_cores_samp_type](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_samp_type)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>1..1</sub> [String](types/String.md)
