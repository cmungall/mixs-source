...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_add_recov_method](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_add_recov_method)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>1..1</sub> [add_recov_method_enum](add_recov_method_enum.md)

## Parents

 *  is_a: [add_recov_method](add_recov_method.md)
