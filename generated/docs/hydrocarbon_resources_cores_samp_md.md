...
URI: [mixs.vocab:hydrocarbon_resources_cores_samp_md](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_samp_md)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>0..1</sub> [samp_md_enum](samp_md_enum.md)

## Parents

 *  is_a: [samp_md](samp_md.md)
