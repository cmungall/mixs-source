...
URI: [mixs.vocab:MIUVIG_neg_cont_type](https://w3id.org/mixs/vocab/MIUVIG_neg_cont_type)


## Domain and Range

[MIUVIG](MIUVIG.md) &#8594;  <sub>0..1</sub> [neg_cont_type_enum](neg_cont_type_enum.md)
