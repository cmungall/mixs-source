...
URI: [mixs.vocab:hydrocarbon_resources_cores_depos_env](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_depos_env)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>0..1</sub> [depos_env_enum](depos_env_enum.md)
