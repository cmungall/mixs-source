...
URI: [mixs.vocab:MIGS_org_samp_vol_we_dna_ext](https://w3id.org/mixs/vocab/MIGS_org_samp_vol_we_dna_ext)


## Domain and Range

[MIGSOrg](MIGSOrg.md) &#8594;  <sub>0..1</sub> [QuantityValue](QuantityValue.md)
