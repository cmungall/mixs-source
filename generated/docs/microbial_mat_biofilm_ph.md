...
URI: [mixs.vocab:microbial_mat_biofilm_ph](https://w3id.org/mixs/vocab/microbial_mat_biofilm_ph)


## Domain and Range

[MicrobialMatBiofilm](MicrobialMatBiofilm.md) &#8594;  <sub>0..1</sub> [Double](types/Double.md)
