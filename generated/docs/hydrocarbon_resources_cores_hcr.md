...
URI: [mixs.vocab:hydrocarbon_resources_cores_hcr](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_hcr)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>1..1</sub> [hcr_enum](hcr_enum.md)
