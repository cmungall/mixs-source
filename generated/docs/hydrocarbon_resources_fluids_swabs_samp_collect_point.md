...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_samp_collect_point](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_samp_collect_point)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>1..1</sub> [samp_collect_point_enum](samp_collect_point_enum.md)

## Parents

 *  is_a: [samp_collect_point](samp_collect_point.md)
