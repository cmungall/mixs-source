...
URI: [mixs.vocab:MIGS_virus_neg_cont_type](https://w3id.org/mixs/vocab/MIGS_virus_neg_cont_type)


## Domain and Range

[MIGSVirus](MIGSVirus.md) &#8594;  <sub>0..1</sub> [neg_cont_type_enum](neg_cont_type_enum.md)
