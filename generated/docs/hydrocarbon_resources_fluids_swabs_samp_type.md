...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_samp_type](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_samp_type)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>1..1</sub> [String](types/String.md)

## Parents

 *  is_a: [samp_type](samp_type.md)
