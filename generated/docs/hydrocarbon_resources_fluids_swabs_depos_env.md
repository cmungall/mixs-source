...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_depos_env](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_depos_env)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>0..1</sub> [depos_env_enum](depos_env_enum.md)

## Parents

 *  is_a: [depos_env](depos_env.md)
