...
URI: [mixs.vocab:MIMS_investigation_type](https://w3id.org/mixs/vocab/MIMS_investigation_type)


## Domain and Range

[MIMS](MIMS.md) &#8594;  <sub>1..1</sub> [investigation_type_enum](investigation_type_enum.md)
