...
URI: [mixs.vocab:MIGS_plant_neg_cont_type](https://w3id.org/mixs/vocab/MIGS_plant_neg_cont_type)


## Domain and Range

[MIGSPlant](MIGSPlant.md) &#8594;  <sub>0..1</sub> [neg_cont_type_enum](neg_cont_type_enum.md)
