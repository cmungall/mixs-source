...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_samp_subtype](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_samp_subtype)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>0..1</sub> [samp_subtype_enum](samp_subtype_enum.md)

## Parents

 *  is_a: [samp_subtype](samp_subtype.md)
