...
URI: [mixs.vocab:hydrocarbon_resources_cores_hcr_geol_age](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_hcr_geol_age)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>0..1</sub> [hcr_geol_age_enum](hcr_geol_age_enum.md)
