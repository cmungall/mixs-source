...
URI: [mixs.vocab:wastewater_sludge_sludge_retent_time](https://w3id.org/mixs/vocab/wastewater_sludge_sludge_retent_time)
 ...
 *  is_a: [sludge_retent_time](sludge_retent_time.md)
