...
URI: [mixs.vocab:miscellaneous_natural_or_artificial_environment_samp_vol_we_dna_ext](https://w3id.org/mixs/vocab/miscellaneous_natural_or_artificial_environment_samp_vol_we_dna_ext)
