...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_hcr_geol_age](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_hcr_geol_age)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>0..1</sub> [hcr_geol_age_enum](hcr_geol_age_enum.md)

## Parents

 *  is_a: [hcr_geol_age](hcr_geol_age.md)
