...
URI: [mixs.vocab:sediment_oxy_stat_samp](https://w3id.org/mixs/vocab/sediment_oxy_stat_samp)


## Domain and Range

[Sediment](Sediment.md) &#8594;  <sub>0..1</sub> [oxy_stat_samp_enum](oxy_stat_samp_enum.md)
