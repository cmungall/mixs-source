...
URI: [mixs.vocab:hydrocarbon_resources_cores_suspend_solids](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_suspend_solids)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>0..\*</sub> [String](types/String.md)
