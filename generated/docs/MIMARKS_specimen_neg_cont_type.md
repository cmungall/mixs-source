...
URI: [mixs.vocab:MIMARKS_specimen_neg_cont_type](https://w3id.org/mixs/vocab/MIMARKS_specimen_neg_cont_type)


## Domain and Range

[MIMARKSSpecimen](MIMARKSSpecimen.md) &#8594;  <sub>0..1</sub> [neg_cont_type_enum](neg_cont_type_enum.md)

## Parents

 *  is_a: [neg_cont_type](neg_cont_type.md)
