...
URI: [mixs.vocab:hydrocarbon_resources_cores_sr_kerog_type](https://w3id.org/mixs/vocab/hydrocarbon_resources_cores_sr_kerog_type)


## Domain and Range

[HydrocarbonResources-cores](HydrocarbonResources-cores.md) &#8594;  <sub>0..1</sub> [sr_kerog_type_enum](sr_kerog_type_enum.md)

## Parents

 *  is_a: [sr_kerog_type](sr_kerog_type.md)
