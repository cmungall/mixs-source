...
URI: [mixs.vocab:human_vaginal_medic_hist_perform](https://w3id.org/mixs/vocab/human_vaginal_medic_hist_perform)
 ...
 *  is_a: [medic_hist_perform](medic_hist_perform.md)
