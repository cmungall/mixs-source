...
URI: [mixs.vocab:MIGS_eukaryote_neg_cont_type](https://w3id.org/mixs/vocab/MIGS_eukaryote_neg_cont_type)


## Domain and Range

[MIGSEukaryote](MIGSEukaryote.md) &#8594;  <sub>0..1</sub> [neg_cont_type_enum](neg_cont_type_enum.md)
