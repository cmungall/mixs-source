...
URI: [mixs.vocab:hydrocarbon_resources_fluids_swabs_lithology](https://w3id.org/mixs/vocab/hydrocarbon_resources_fluids_swabs_lithology)


## Domain and Range

[HydrocarbonResources-fluidsSwabs](HydrocarbonResources-fluidsSwabs.md) &#8594;  <sub>0..1</sub> [lithology_enum](lithology_enum.md)

## Parents

 *  is_a: [lithology](lithology.md)
